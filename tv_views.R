...
ggplot(tv_data, show.legend = FALSE, aes(x = viewers, y = hits)) +
...
# Viewers by Date
ggplot(tv_data, show.legend = FALSE, aes(x = date, y = viewers )) +
    theme_minimal() +
    geom_smooth(show.legend = FALSE,
                color = "black",
                fullrange = TRUE,
...
ggplot(tv_data, show.legend = FALSE, aes(x = date, y = hits )) +
    theme_minimal() +
    geom_smooth(show.legend = FALSE,
                color = "black",
                fullrange = TRUE,
